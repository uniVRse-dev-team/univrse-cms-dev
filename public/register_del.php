...
<meta charset="UTF-8">
    ...
    <title>Registration Form - Delegate</title>
...
<p class="desc">Attend the virtual event organized and hosted in UniVRse Metaverse Event Platform with the topic of Leading Technology in the New Era.</p> 

<div class="wrapper">

<div class="title">
      <h4>Register As Delegate</h4>
</div>
	...
	<form action="register_del_process.php" method="POST">
    <div class="form">
