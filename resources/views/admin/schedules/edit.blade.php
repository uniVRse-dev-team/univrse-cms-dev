...
<div class="card">
    ...
    <i class="fa-fw fas fa-clock-o c-sidebar-nav-icon"></i>
        <b>{{ trans('global.edit') }} {{ trans('cruds.schedule.title_singular') }}</b>
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.schedules.update", [$schedule->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('sch_start_time') ? 'is-invalid' : '' }}" type="text" name="sch_start_time" id="sch_start_time" value="{{ old('sch_start_time', $schedule->sch_start_time) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('sch_end_time') ? 'is-invalid' : '' }}" type="text" name="sch_end_time" id="sch_end_time" value="{{ old('sch_end_time', $schedule->sch_end_time) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sch_title') ? 'is-invalid' : '' }}" type="text" name="sch_title" id="sch_title" value="{{ old('sch_title', $schedule->sch_title) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sch_description') ? 'is-invalid' : '' }}" type="text" name="sch_description" id="sch_description" value="{{ old('sch_description', $schedule->sch_description) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sch_pic') ? 'is-invalid' : '' }}" type="text" name="sch_pic" id="sch_pic" value="{{ old('sch_pic', $schedule->sch_pic) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sch_venue') ? 'is-invalid' : '' }}" type="text" name="sch_venue" id="sch_venue" value="{{ old('sch_venue', $schedule->sch_venue) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sch_price') ? 'is-invalid' : '' }}" type="text" name="sch_price" id="sch_price" value="{{ old('sch_price', $schedule->sch_price) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sch_max_pax') ? 'is-invalid' : '' }}" type="text" name="sch_max_pax" id="sch_max_pax" value="{{ old('sch_max_pax', $schedule->sch_max_pax) }}" required>
