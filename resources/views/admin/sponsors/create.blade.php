...
<div class="card">
    ...
    <i class="fa-fw fas fa-hand-holding-usd c-sidebar-nav-icon"></i>
        <b>{{ trans('global.create') }} {{ trans('cruds.sponsor.title_singular') }}</b>
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.sponsors.store") }}" enctype="multipart/form-data" autocomplete="off">
            @csrf
            <div class="form-group">
                <label class="required" for="spo_register">{{ trans('cruds.sponsor.fields.spo_register') }}</label>
                <input class="form-control {{ $errors->has('spo_register') ? 'is-invalid' : '' }}" type="text" name="spo_register" id="spo_register" value="{{ old('spo_register', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spo_name') ? 'is-invalid' : '' }}" type="text" name="spo_name" id="spo_name" value="{{ old('spo_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spo_adr_1') ? 'is-invalid' : '' }}" type="text" name="spo_adr_1" id="spo_adr_1" value="{{ old('spo_adr_1', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spo_adr_2') ? 'is-invalid' : '' }}" type="text" name="spo_adr_2" id="spo_adr_2" value="{{ old('spo_adr_2', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spo_postcode') ? 'is-invalid' : '' }}" type="text" name="spo_postcode" id="spo_postcode" value="{{ old('spo_postcode', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spo_city') ? 'is-invalid' : '' }}" type="text" name="spo_city" id="spo_city" value="{{ old('spo_city', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spo_state') ? 'is-invalid' : '' }}" type="text" name="spo_state" id="spo_state" value="{{ old('spo_state', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spo_country') ? 'is-invalid' : '' }}" type="text" name="spo_country" id="spo_country" value="{{ old('spo_country', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spo_email') ? 'is-invalid' : '' }}" type="text" name="spo_email" id="spo_email" value="{{ old('spo_email', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spo_pic') ? 'is-invalid' : '' }}" type="text" name="spo_pic" id="spo_pic" value="{{ old('spo_pic', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spo_position') ? 'is-invalid' : '' }}" type="text" name="spo_position" id="spo_position" value="{{ old('spo_position', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spo_office') ? 'is-invalid' : '' }}" type="text" name="spo_office" id="spo_office" value="{{ old('spo_office', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spo_mobile') ? 'is-invalid' : '' }}" type="text" name="spo_mobile" id="spo_mobile" value="{{ old('spo_mobile', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('spo_package') ? 'is-invalid' : '' }}" name="spo_package" id="spo_package" required>
                    ...
                    @foreach(App\Models\Sponsor::SPO_PACKAGE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('spo_package', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spo_product') ? 'is-invalid' : '' }}" type="text" name="spo_product" id="spo_product" value="{{ old('spo_product', '') }}" required>
                @if($errors->has('spo_product'))
                    <div class="invalid-feedback">
                        {{ $errors->first('spo_product') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.sponsor.fields.spo_product_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="spo_amount">{{ trans('cruds.sponsor.fields.spo_amount') }}</label>
                <input class="form-control {{ $errors->has('spo_amount') ? 'is-invalid' : '' }}" type="text" name="spo_amount" id="spo_amount" value="{{ old('spo_amount', '') }}" required>
