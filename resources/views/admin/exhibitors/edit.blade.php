...
<div class="card">
    ...
    <i class="fa-fw fas fa-user c-sidebar-nav-icon"></i>
        <b>{{ trans('global.edit') }} {{ trans('cruds.exhibitor.title_singular') }}</b>
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.exhibitors.update", [$exhibitor->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('exh_register') ? 'is-invalid' : '' }}" type="text" name="exh_register" id="exh_register" value="{{ old('exh_register', $exhibitor->exh_register) }}" required>
            ...
            <div class="form-group">
                <label class="required" for="exh_name">Exhibition Name</label>
                <input class="form-control {{ $errors->has('exh_name') ? 'is-invalid' : '' }}" type="text" name="exh_name" id="exh_name" value="{{ old('exh_name', $exhibitor->exh_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('exh_adr_1') ? 'is-invalid' : '' }}" type="text" name="exh_adr_1" id="exh_adr_1" value="{{ old('exh_adr_1', $exhibitor->exh_adr_1) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('exh_adr_2') ? 'is-invalid' : '' }}" type="text" name="exh_adr_2" id="exh_adr_2" value="{{ old('exh_adr_2', $exhibitor->exh_adr_2) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('exh_postcode') ? 'is-invalid' : '' }}" type="text" name="exh_postcode" id="exh_postcode" value="{{ old('exh_postcode', $exhibitor->exh_postcode) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('exh_city') ? 'is-invalid' : '' }}" type="text" name="exh_city" id="exh_city" value="{{ old('exh_city', $exhibitor->exh_city) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('exh_state') ? 'is-invalid' : '' }}" type="text" name="exh_state" id="exh_state" value="{{ old('exh_state', $exhibitor->exh_state) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('exh_country') ? 'is-invalid' : '' }}" type="text" name="exh_country" id="exh_country" value="{{ old('exh_country', $exhibitor->exh_country) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('exh_email') ? 'is-invalid' : '' }}" type="email" name="exh_email" id="exh_email" value="{{ old('exh_email', $exhibitor->exh_email) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('exh_pic') ? 'is-invalid' : '' }}" type="text" name="exh_pic" id="exh_pic" value="{{ old('exh_pic', $exhibitor->exh_pic) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('exh_position') ? 'is-invalid' : '' }}" type="text" name="exh_position" id="exh_position" value="{{ old('exh_position', $exhibitor->exh_position) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('exh_office') ? 'is-invalid' : '' }}" type="text" name="exh_office" id="exh_office" value="{{ old('exh_office', $exhibitor->exh_office) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('exh_mobile') ? 'is-invalid' : '' }}" type="text" name="exh_mobile" id="exh_mobile" value="{{ old('exh_mobile', $exhibitor->exh_mobile) }}" required>
                @if($errors->has('exh_mobile'))
                    <div class="invalid-feedback">
                        {{ $errors->first('exh_mobile') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.exhibitor.fields.exh_bcolor1_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="exh_bcolor1">{{ trans('cruds.exhibitor.fields.exh_bcolor1') }}</label>
                <input class="form-control {{ $errors->has('exh_bcolor1') ? 'is-invalid' : '' }}" type="text" name="exh_bcolor1" id="exh_bcolor1" value="{{ old('exh_bcolor1', $exhibitor->exh_bcolor1) }}" required>
            ...
            <div class="form-group">
                <label class="required" for="exh_bcolor2">{{ trans('cruds.exhibitor.fields.exh_bcolor2') }}</label>
                <input class="form-control {{ $errors->has('exh_bcolor2') ? 'is-invalid' : '' }}" type="text" name="exh_bcolor2" id="exh_bcolor2" value="{{ old('exh_bcolor2', $exhibitor->exh_bcolor2) }}" required>
                @if($errors->has('exh_bcolor2'))
                    <div class="invalid-feedback">
                        {{ $errors->first('exh_bcolor2') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.exhibitor.fields.exh_bcolor2_helper') }}</span>
            </div>
            <div class="form-group">
