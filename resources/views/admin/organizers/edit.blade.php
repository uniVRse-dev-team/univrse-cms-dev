...
<div class="card">
    ...
    <i class="fa-fw fas fa-user-tie c-sidebar-nav-icon"></i>
        {{ trans('global.edit') }} {{ trans('cruds.organizer.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.organizers.update", [$organizer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('org_register') ? 'is-invalid' : '' }}" type="text" name="org_register" id="org_register" value="{{ old('org_register', $organizer->org_register) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('org_name') ? 'is-invalid' : '' }}" type="text" name="org_name" id="org_name" value="{{ old('org_name', $organizer->org_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('org_adr_1') ? 'is-invalid' : '' }}" type="text" name="org_adr_1" id="org_adr_1" value="{{ old('org_adr_1', $organizer->org_adr_1) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('org_adr_2') ? 'is-invalid' : '' }}" type="text" name="org_adr_2" id="org_adr_2" value="{{ old('org_adr_2', $organizer->org_adr_2) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('org_postcode') ? 'is-invalid' : '' }}" type="text" name="org_postcode" id="org_postcode" value="{{ old('org_postcode', $organizer->org_postcode) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('org_city') ? 'is-invalid' : '' }}" type="text" name="org_city" id="org_city" value="{{ old('org_city', $organizer->org_city) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('org_state') ? 'is-invalid' : '' }}" type="text" name="org_state" id="org_state" value="{{ old('org_state', $organizer->org_state) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('org_country') ? 'is-invalid' : '' }}" type="text" name="org_country" id="org_country" value="{{ old('org_country', $organizer->org_country) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('org_email') ? 'is-invalid' : '' }}" type="email" name="org_email" id="org_email" value="{{ old('org_email', $organizer->org_email) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('org_pic') ? 'is-invalid' : '' }}" type="text" name="org_pic" id="org_pic" value="{{ old('org_pic', $organizer->org_pic) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('org_position') ? 'is-invalid' : '' }}" type="text" name="org_position" id="org_position" value="{{ old('org_position', $organizer->org_position) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('org_office') ? 'is-invalid' : '' }}" type="text" name="org_office" id="org_office" value="{{ old('org_office', $organizer->org_office) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('org_mobile') ? 'is-invalid' : '' }}" type="text" name="org_mobile" id="org_mobile" value="{{ old('org_mobile', $organizer->org_mobile) }}" required>
