...
<div class="card">
    ...
    <i class="fa-fw fas fa-user c-sidebar-nav-icon"></i>
        <b>{{ trans('global.edit') }} {{ trans('cruds.delegate.title_singular') }}</b>
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.delegates.update", [$delegate->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('del_name') ? 'is-invalid' : '' }}" type="text" name="del_name" id="del_name" value="{{ old('del_name', $delegate->del_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('del_position') ? 'is-invalid' : '' }}" type="text" name="del_position" id="del_position" value="{{ old('del_position', $delegate->del_position) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('del_office') ? 'is-invalid' : '' }}" type="text" name="del_office" id="del_office" value="{{ old('del_office', $delegate->del_office) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('del_mobile') ? 'is-invalid' : '' }}" type="text" name="del_mobile" id="del_mobile" value="{{ old('del_mobile', $delegate->del_mobile) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('del_email') ? 'is-invalid' : '' }}" type="text" name="del_email" id="del_email" value="{{ old('del_email', $delegate->del_email) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('del_adr_1') ? 'is-invalid' : '' }}" type="text" name="del_adr_1" id="del_adr_1" value="{{ old('del_adr_1', $delegate->del_adr_1) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('del_adr_2') ? 'is-invalid' : '' }}" type="text" name="del_adr_2" id="del_adr_2" value="{{ old('del_adr_2', $delegate->del_adr_2) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('del_postcode') ? 'is-invalid' : '' }}" type="text" name="del_postcode" id="del_postcode" value="{{ old('del_postcode', $delegate->del_postcode) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('del_city') ? 'is-invalid' : '' }}" type="text" name="del_city" id="del_city" value="{{ old('del_city', $delegate->del_city) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('del_state') ? 'is-invalid' : '' }}" type="text" name="del_state" id="del_state" value="{{ old('del_state', $delegate->del_state) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('del_country') ? 'is-invalid' : '' }}" type="text" name="del_country" id="del_country" value="{{ old('del_country', $delegate->del_country) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Delegate::DEL_SPEAKER_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('del_speaker') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="del_speaker_{{ $key }}" name="del_speaker" value="{{ $key }}" {{ old('del_speaker', $delegate->del_speaker) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('del_twitter') ? 'is-invalid' : '' }}" type="text" name="del_twitter" id="del_twitter" value="{{ old('del_twitter', $delegate->del_twitter) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('del_linkedin') ? 'is-invalid' : '' }}" type="text" name="del_linkedin" id="del_linkedin" value="{{ old('del_linkedin', $delegate->del_linkedin) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('del_facebook') ? 'is-invalid' : '' }}" type="text" name="del_facebook" id="del_facebook" value="{{ old('del_facebook', $delegate->del_facebook) }}">
